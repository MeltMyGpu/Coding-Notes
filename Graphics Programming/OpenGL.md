OpenGL is a specification for an api that allows developers to access and use GPU hardware in a standardised way, this specification is implemented by the graphic card manufacturers.
